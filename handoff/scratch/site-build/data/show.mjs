...
const r = await buildCollection({ root, rpc: createRpc({ url: "https://x.test", fetchImpl: fake.fetchImpl, delayMs: 0 }), log: console.log, nowMs: Date.parse("2026-09-25T18:00:00Z") });
console.log(readData(root, "collection.json")); console.log(readData(root, "collection-state.json"));
