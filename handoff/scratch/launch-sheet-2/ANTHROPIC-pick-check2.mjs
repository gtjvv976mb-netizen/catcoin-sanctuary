...
const coins = [
  { id: "fixA", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK,
    blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, sits by the garden bench all day and blinks slowly at anyone hard at work nearby." },
  { id: "fixB", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK,
    blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, naps by the Cat Sanctuary garden bench and blinks slowly at anyone hard at work nearby." },
  { id: "fixC", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK,
    blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, dozes on the Cat Sanctuary garden wall and blinks slowly at anyone hard at work nearby." },
];
