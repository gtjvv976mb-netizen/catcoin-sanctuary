const u = "https://en.wikipedia.org/w/api.php?action=query&prop=extracts&explaintext=1&format=json&titles=IREN&redirects=1";
...
console.log("LEAD ::", t.slice(0, 1500));
for (const k of ["hydro", "renewable", "bitcoin", "GPU", "AI cloud", "data cent", "British Columbia", "Texas", "Childress", "wind", "solar", "liquid", "cool"]) {
