...
const stockTerms = { stock: ["RUM", "RUM Group", "RUM Group Inc", "Rumble", "Rumble Inc", "Rumble Viral", "Rumble Video", "rumblevideo", "rumbledotcom", "Rumble Cloud", "Rumble Wallet", "Rumble Studio", "Rumble Technology", "Rumbl", "Locals", "Quake", "Quake AI", "Chris Pavlovski", "Pavlovski", "Mittens", "Tether", "Northern Data", "CF Acquisition", "Cantor", "Backpack", "Backpack Securities", "Sunrise", "Wormhole", "Periscope"] };
const banned = new Set(["RUM","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","MITTENS","TOONCES","KEYCAT","MANEKI","SMUDGE","JENNA"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasRumRoot: c.ticker.includes("RUM") };
