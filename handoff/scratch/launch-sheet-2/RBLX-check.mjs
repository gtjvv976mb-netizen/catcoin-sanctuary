...
const stockTerms = { stock: ["RBLX", "Roblox", "Roblox Corporation", "Roblox Corp", "Robux", "Rthro", "Bloxy", "Builderman", "Baszucki", "David Baszucki", "Cassel", "Business Cat", "Sir Meows A Lot", "Meows", "DenisDaily", "Denis",
  "Tabbs", "Sergeant Tabbs", "Sergeant", "Medic Lily", "Lily", "Commander Laika", "Laika", "Blue Collar Cat", "Cats in Space", "Cuddly Cat", "Krazy Kitty", "Kitty", "Cheshire", "Nyan", "TPS", "TPS report", "right meow", "Mondays",
  "Hello Kitty", "Sanrio", "Cinnamoroll", "Rock Panda", "Adopt Me", "Exclusible", "Backpack", "Backpack Securities", "Sunrise", "Wormhole", "Garfield", "Blox", "Oof"] };
const banned = new Set(["POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","RBLX","ROBLOX","ROBUX","BIZCAT","BUSINESS"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasRblxRoot: c.ticker.includes("RBLX") };
