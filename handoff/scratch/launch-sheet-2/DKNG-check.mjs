...
const stockTerms = { stock: ["DKNG", "DK", "DraftKings", "Draft Kings", "Draft", "Kings", "DKNGx", "DraftKings Predictions", "DraftKings Sportsbook", "DraftKings Casino", "DK Network", "Crown", "Crown Cash",
  ...
  "Lion Carnival", "Lightning Lion", "Jaguar Princess", "Rising Tiger", "Silver Lioness", "50 Lions", "Backpack", "Backpack Securities", "Sunrise", "Wormhole", "ESPN", "ESPN Bet"] };
const banned = new Set(["POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","DKNG","DK","HODL"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasDkRoot: /DK|DKNG/.test(c.ticker) };
