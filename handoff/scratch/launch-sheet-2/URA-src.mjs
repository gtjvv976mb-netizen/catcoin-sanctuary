const r = await fetch("https://www.globalxetfs.com/funds/ura/", { headers: { "user-agent": "Mozilla/5.0 (cat-sanctuary-research)" } });
...
for (const k of ["seeks to provide", "uranium mining", "nuclear components", "Solactive", "Inception", "Net Assets", "Key Features", "Holdings"]) {
