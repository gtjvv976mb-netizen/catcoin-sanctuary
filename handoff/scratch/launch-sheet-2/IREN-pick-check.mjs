...
const pick = {
  ...
  ticker: "MILLRACE",
  blurb: "Millrace, a plush blue-grey tabby with rippling darker stripes and pale green eyes, sits by the garden stream watching the water turn the little wooden wheel.",
};
