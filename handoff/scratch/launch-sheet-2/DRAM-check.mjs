...
const stockTerms = { stock: ["DRAM","DRAMx","RAM","Roundhill","Roundhill Investments","Roundhill Memory ETF","Memory","Backpack","Backpack Securities","Sunrise","Wormhole","Dave Mazza","Mazza","Micron","Samsung","SK Hynix","Hynix","SanDisk","Kioxia","HBM","NAND","DIMM"] };
const banned = new Set(["POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","DRAM","RAM","ROUNDHILL","KEYCAT","SIGMA","MOG","MANEKI","HOBBES","GME","WIF","BONK","SC","CATWIF","MANEKI","PURR","MEOW"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasDRAMorRAM: /DRAM|RAM/.test(c.ticker) };
