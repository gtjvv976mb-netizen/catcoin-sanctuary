...
const LOOK = "Solid rust or terracotta orange short-haired house cat with no markings, sleek build, golden eyes, wears nothing.";
const coins = [
  { id: "fixD", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK, blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, sits by the garden bench all day and gives a sleepy wink to anyone hard at work nearby." },
  { id: "fixE", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK, blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, keeps watch from the garden bench all day and purrs at anyone hard at work nearby." },
  { id: "fixF", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK, blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, sits by the garden bench all day and narrows her eyes fondly at anyone hard at work nearby." },
  { id: "fixG", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK, blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, sits by the sanctuary garden bench all day and gives a sleepy wink to anyone hard at work." },
  { id: "fixH", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK, blurb: "Cotta, a sleek terracotta-orange cat with golden eyes, lounges on the sanctuary garden bench and gives a sleepy wink to anyone hard at work nearby." },
];
