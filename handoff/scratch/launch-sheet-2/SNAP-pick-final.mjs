// Checker pass for SNAP (backpack): the fixed pick (gold-brown eyes -> honey eyes, to clear GOLD/Brown other-pair hits; pads -> trots, to clear the S&P compact false positive).
...
const coins = [
  { id: "PICK", name: "Sandstep the Tawny Cat", ticker: "SANDSTEP", disc: DISC,
    look: "Lean tawny short-haired house cat, cream chest and muzzle, dark-tipped tail, honey eyes, wears nothing.",
    blurb: "Sandstep, a lean tawny shorthair with a cream chest, dark-tipped tail and honey eyes, trots across the little garden footbridge every dusk." },
];
