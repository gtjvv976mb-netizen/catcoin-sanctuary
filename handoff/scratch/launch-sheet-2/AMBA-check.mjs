...
const stockTerms = { stock: ["AMBA", "Ambarella", "Ambarella Inc", "Amba", "Amber", "Ambar", "Fermi", "Feng-Ming", "Fermi Wang", "Wang", "Les Kohn", "Kohn", "CVflow", "CV3", "CV2", "Oculii", "VisLab", "Cooper", "GoPro", "Hero", "Dropcam", "Nest", "Garmin", "DJI", "Phantom", "Harmonic", "Axis", "Bosch", "Inceptio", "Alberto Broggi", "Broggi", "Backpack", "Backpack Securities", "Sunrise", "Wormhole", "Santa Clara"] };
const banned = new Set(["AMBA","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","ROAR","ROARING","AMC","APE","HODL"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasAmbaRoot: c.ticker.includes("AMBA") };
