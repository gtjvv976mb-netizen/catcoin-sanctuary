...
const stockTerms = { stock: ["AMC", "AMC Entertainment", "AMC Entertainment Holdings", "AMC Theatres", "AMC Theaters", "American Multi-Cinema", "Multi-Cinema", "AMCx",
  ...
  "Puss in Boots", "Nicole Kidman", "Kidman", "Garfield", "Flow", "CatVideoFest", "A Meme Coin", "Fandango", "Popcorn"] };
const banned = new Set(["POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","ROAR","ROARING","AMC","APE","HODL"]);
const results = [];
