...
const stockTerms = { stock: ["PTN", "Palatin", "Palatin Technologies", "Palatin Technologies, Inc.", "Vyleesi", "bremelanotide", "Cosette", "Boehringer", "Boehringer Ingelheim", "Carl Spana", "Spana", "PL9643", "PL7737", "PL8177", "Princeton", "Carnegie", "Backpack", "Backpack Securities", "Sunrise", "melanocortin", "MC1R", "MC4R", "pinwheel", "Hello Kitty", "Kitty"] };
const banned = new Set(["POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","TORTIE","PTN","PALATIN"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasPtnRoot: c.ticker.includes("PTN") || c.ticker.includes("PALA") };
