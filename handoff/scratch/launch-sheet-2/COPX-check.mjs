...
const stockTerms = { stock: ["COPX", "COP", "Copper", "Copper Miners", "Miners", "Global X", "GlobalX", "Global X ETFs", "Global X Copper Miners ETF", "Global X Management", "Mirae", "Mirae Asset", "TIGER", "Tiger ETF", "Smart Tiger", "Ryan O'Connor", "O'Connor", "Luis Berruga", "Berruga", "Park Hyeon-joo", "Hyeon-joo", "Solactive", "Beyond Ordinary", "Backpack", "Backpack Securities", "Sunrise", "Wormhole", "Freeport", "McMoRan", "Southern Copper", "Teck", "Antofagasta", "Glencore", "BHP", "Ivanhoe", "First Quantum", "Lundin", "Zijin", "Boliden", "KGHM", "Hudbay", "Codelco"] };
const banned = new Set(["COPX","COPPER","COP","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","TIGER","URANIUM","NUKE"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasCopxRoot: c.ticker.includes("COPX") || c.ticker.includes("COP") };
