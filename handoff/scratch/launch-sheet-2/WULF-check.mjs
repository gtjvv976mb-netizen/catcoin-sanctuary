...
const stockTerms = { stock: ["WULF","TeraWulf","Tera","Wulf","Wolf","Wolves","Beowulf","Paul Prager","Prager","Nazar Khan","Nazar","Khan","Lake Mariner","Mariner","Hawkeye","Justified","Chesapeake","Muskie","Nautilus","Somerset","Century","Hawesville","Morgantown","Hunterbrook","Bitcoin","BTC","Satoshi","Marathon","Fluidstack","Google","Backpack","Backpack Securities","Sunrise","Wormhole","Kentucky","Niagara"] };
const banned = new Set(["WULF","WOLF","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","ROAR","ROARING","AMC","APE","HODL"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasWulfRoot: /WULF|WOLF|TERA/.test(c.ticker) };
