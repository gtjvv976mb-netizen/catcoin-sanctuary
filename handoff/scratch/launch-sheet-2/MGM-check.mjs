...
const stockTerms = { stock: ["MGM", "MGM Resorts", "MGM Resorts International", "Resorts", "MGM Grand", "Grand Lion", "Leo", "Leo the Lion", "Leona", "Leona the Lioness", "Lion", "Lioness", "Bellagio", "Mirage", "Mandalay", "Mandalay Bay", "Park MGM", "The Park", "Excalibur", "Luxor", "Aria", "Vdara", "Borgata", "BetMGM", "Metro Goldwyn Mayer", "Goldwyn", "Mayer", "Hornbuckle", "Bill Hornbuckle", "Phyllis James", "Siegfried", "Roy", "Hello Kitty", "Sanrio", "Bruno Mars", "Vegas", "Las Vegas", "Strip", "Dunes", "Sahara", "Casino", "Jackpot", "Backpack", "Backpack Securities", "Sunrise", "Wormhole"] };
const banned = new Set(["MGM","LEO","LION","LEONA","AMBA","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","ROAR","ROARING","AMC","APE","HODL"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasMgmRoot: c.ticker.includes("MGM") };
