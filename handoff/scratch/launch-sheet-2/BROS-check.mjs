...
const stockTerms = { stock: ["BROS", "BRO", "Dutch Bros", "Dutch Bros Inc", "Dutch", "Bros", "Dutch Bros Coffee", "Dutch Brothers", "Broista", "Broistas", "Dutch Pup", "Dutch Buddy", "Dutch Luxury", "Dutch at Home", "Dutch Mafia", "Dutch Bros Records", "Laser Cat", "Laser", "Tiger's Blood", "Tigers Blood", "Rad Tiger", "Tiger", "Tuxedo", "Rebel", "Blue Rebel", "Golden Eagle", "Annihilator", "Kicker", "Caramelizer", "Soft Top", "Starry Night", "Vampire Slayer", "Astronaut", "Cotton Candy", "Windmill", "Boersma", "Travis Boersma", "Travis", "Dane Boersma", "Christine Barone", "Barone", "Grants Pass", "Oregon", "Backpack", "Backpack Securities", "Sunrise", "Wormhole"] };
const banned = new Set(["BROS","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","ROAR","ROARING","AMC","APE","HODL"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasBrosRoot: c.ticker.includes("BROS") };
