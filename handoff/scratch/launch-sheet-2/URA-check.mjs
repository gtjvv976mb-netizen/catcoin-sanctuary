...
const stockTerms = { stock: ["URA", "Uranium", "Global X", "GlobalX", "Global X ETFs", "Global X Uranium ETF", "Global X Management", "Mirae", "Mirae Asset", "TIGER", "Tiger ETF", "Smart Tiger", "Ryan O'Connor", "O'Connor", "Luis Berruga", "Berruga", "Park Hyeon-joo", "Hyeon-joo", "Solactive", "Nuclear", "Beyond Ordinary", "Backpack", "Backpack Securities", "Sunrise", "Wormhole", "Cameco", "Kazatomprom", "NexGen", "Uranium Energy", "Denison", "Yellowcake"] };
const banned = new Set(["URA","POPCAT","MEW","MICHI","GRUMPY","KITTY","CAT","CATS","NYAN","KITTEN","TABBY","MOG","MANEKI","HOBBES","WIF","BONK","CATWIF","PURR","MEOW","SIMON","GIKO","BOOK","NUB","SNOWBALL","TIGER","URANIUM","NUKE"]);
const results = [];
for (const c of coins) {
  const desc = `${c.blurb} ${DISC}`;
  const out = { name: c.name, ticker: c.ticker, nameLen: c.name.length, blurbLen: c.blurb.length, descLen: desc.length, tickerHasUraRoot: c.ticker.includes("URA") };
