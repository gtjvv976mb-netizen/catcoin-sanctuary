...
const LOOK = "Solid rust or terracotta orange short-haired house cat with no markings, sleek build, bright yellow eyes, wears nothing.";
const coins = [
  { id: "PICK", name: "Cotta the Terracotta Cat", ticker: "COTTAPAW", disc: DISC_FIX, look: LOOK,
    blurb: "Cotta, a sleek terracotta-orange cat with bright yellow eyes, lounges on the sanctuary garden bench and gives a sleepy wink to anyone hard at work." },
];
