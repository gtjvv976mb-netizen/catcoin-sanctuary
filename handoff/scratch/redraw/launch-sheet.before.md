...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Snowcurl is a sleek white cat with her tail held high and curled at the tip. On hot days she finds cool shade, lifts a paw to wash her face and waits calmly. A cat coin priced in TSLAx. Not affiliated with Tesla, Inc. or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "tesla", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 22/32, ticker 8/10, description 272/280.
...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Sockfoot is a grey tabby with a white bib and four white paws like socks. At first light he walks the edge of the lawn, tail held high, the first cat up. A cat coin priced in NVDAx. Not affiliated with NVIDIA Corporation or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "nvidia", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 24/32, ticker 8/10, description 275/280.
...
- **Token name:** `Halfsmile Cat`
- **Symbol:** `HALFSMILE`
- **Token image:** `images/HALFSMILE.png`
- **Quote token:** **MSFTX** (listed as "MSFT"), mint `XspzcW1PRtgf6Wj92HCiZdjzKCyFekVD8P5Ueh3dRMX`
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > A grey-and-white cat with grey-green eyes and a crooked grin that looks cross until you see she is pleased. She grins at all who pass her garden bench. A cat coin priced in MSFTx. Not affiliated with Microsoft Corporation or StonkFun. No intrinsic value; not financial advice.
- **Why it looks like this:** She follows Jellie, the real grey-and-white cat with grey-green eyes who became a Minecraft cat skin (Microsoft owns Mojang). Her owner's 'grumpy smile' became the crooked grin. Jellie's name and the game are not used.
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "microsoft", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 13/32, ticker 9/10, description 276/280.

### 8. GOOGLx → PORCHLIGHT

- **Token name:** `Porchlight the Dusk Cat`
- **Symbol:** `PORCHLIGHT`
- **Token image:** `images/PORCHLIGHT.png`
- **Quote token:** **GOOGLX** (listed as "GOOGLE"), mint `XsCPL9dNWBMvFtTmwcCA5v3xWPSMEBCszbQdiLLq6aN`
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Porchlight is a solid black cat with a shiny coat and bright yellow eyes. When the garden lanterns glow, she sits on the porch step and slowly blinks hello. A cat coin priced in GOOGLx. Not affiliated with Alphabet Inc. or StonkFun. No intrinsic value; not financial advice.
- **Why it looks like this:** The recurring black cat in Google's Halloween Doodle games was drawn from a Doodle artist's real black cat with yellow eyes. Only the coat and eye colour are used.
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "alphabet", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 23/32, ticker 10/10, description 274/280.

### 9. AMZNx → SUNMANE

- **Token name:** `Sunmane the Sundial Cat`
- **Symbol:** `SUNMANE`
- **Token image:** `images/SUNMANE.png`
- **Quote token:** **AMZNX** (listed as "AMAZON"), mint `Xs3eBt7uRfJX8QUs4suhyU8p2M6DoUDrJyWBa8LLZsg`
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Sunmane, a sturdy tawny cat with a fluffy ruff like a little mane, sits on the old sundial all day and turns slowly to follow the sun. A cat coin priced in AMZNx. Not affiliated with Amazon or StonkFun. No intrinsic value; not financial advice.
- **Why it looks like this:** Big-cat link: the MGM lion, now used by Amazon MGM Studios. He is a plain tawny house cat with a mane-like ruff on his neck. The logo's ring, the roar and the lion's name are left out.
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "amazon", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 23/32, ticker 7/10, description 244/280.
...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > A fluffy brown tabby with golden eyes who claims the sofa every evening, remote in paw, picks the show for the whole house and naps before the ending. A cat coin priced in METAx. Not affiliated with Meta Platforms, Inc. or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "meta", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 17/32, ticker 8/10, description 274/280.

### 11. COINx → HARRUMPH

- **Token name:** `Harrumph the Pouty Cat`
- **Symbol:** `HARRUMPH`
- **Token image:** `images/HARRUMPH.png`
- **Quote token:** **COINX** (listed as "COIN"), mint `Xs7ZdzSHLU9ftNJsii5fCeJhoRWSC32SQGzGQtePxNu`
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Harrumph, a fluffy grey long-haired cat with a flat face and a grumpy pout, glares at pigeons from the garden wall all morning, then climbs into a lap to purr. A cat coin priced in COINx. Not affiliated with Coinbase or StonkFun. No intrinsic value; not financial advice.
- **Why it looks like this:** He is the fluffy, flat-faced, grey-taupe cat with a sulky pout from Coinbase's 2024 brand campaign. That cat's name is not used.
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "coinbase", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 22/32, ticker 8/10, description 271/280.
...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Pewter, a silver-grey tabby with dark stripes on her cheeks, a white chin and a pink nose, rolls in the catmint patch each afternoon until she is happily dizzy. A cat coin priced in HOODx. Not affiliated with Robinhood or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "robinhood", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 22/32, ticker 6/10, description 273/280.
...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Warmspot, a black-and-white tuxedo cat with a white stripe down her nose and a white chin, always finds the one warm spot in a snowy garden, and keeps it. A cat coin priced in SPCXx. Not affiliated with SpaceX or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "spacex", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 23/32, ticker 8/10, description 264/280.
...
- **Token name:** `Moat Cat`
- **Symbol:** `MOATCAT`
- **Token image:** `images/MOATCAT.png`
- **Quote token:** **BRKX** (listed as "BRKX"), mint `Xs6B6zawENwAbWVi7w92rjazLuAr5Az59qgWKcNb45x`
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > A white calico with one ginger ear and one black ear. She sits by the garden pond as if it were her moat and lets nothing cross it but butterflies. A cat coin priced in BRK.Bx. Not affiliated with Berkshire Hathaway or StonkFun. No intrinsic value; not financial advice.
- **Why it looks like this:** She follows Cam the Cat, a Squishmallows plush made by Jazwares, a Berkshire subsidiary: a white calico with one ginger ear, one black ear and one black front leg. She is drawn as a real cat, not a plush. 'Moat' is an ordinary investing word.
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields on the full description flags only the required disclosure (brand "stonkfun", endorsement "affiliated", financial_promise "financial advice"). Jupiter: no token with that symbol. StonkFun: symbol and name not used yet. Lengths: name 8/32, ticker 7/10, description 270/280.
