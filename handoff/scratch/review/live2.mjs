...
const TOK = { MEW: "MEW1gQWJ3nEXg2qgERiKu7FAFj79PHvQVREQUzScPP5", POPCAT: "7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr", KITTY: "4N4DnNo3qpPks9aQCkcWkzoir8tnvT6diS4TnnZibonk", GRUMPY: "GRUmPYbiTpq9ZPy5LAqBMMze7kErf5dEX2i9qYfwoSmR", ZCAT: "HcRLc9VDgjLeK154xDawfb1dmVJ98DoSqcwTHGqiDeJR", GOCAT: "ALAgByDys8imQqy6ZVKWBnUkpU3dugNvUkxW7AUPgvhV", PUMPCAT: "DFQHUegJWE29Xu3BUxPezqi77uyHURRyxJpdtyvLpump", SEKR: "9dzhHR5ZonQbR3uAdYiH9si7itp62HWV5rBBs45apump", SOLCAT: "9U1f18idDeySFnYrurxqT1f5n5nE4g4Uk5LLzP69bh1", APECAT: "7XiFJgX4nkER8gTH1LXUX1VEBJrLRSZfFXuzDy8ccWGT", STONKCATS: "9h5AzEQzYu9CV5K6uLtFRMD1KcbxZSFNxZEgBTNfw5Na", LEVERCAT: "AGi2s9zPRPHs3zEDPhPTroumTEXK5ufymYSfEFndCSSW", BUYCAT: "E4Ap4icMLwKot8rkkTbq5JkS5kZxt5XCE3yfxbzYBjHx", RAYCAT: "CFNRDaxFcvRwRSNnA5cHrCCr6AHhk9dNkHWpRUjNupFL", SOMECAT: "6kNNgyrdvjkRC8eRGQqx5sLfZG2jTmg3NCFmkX2hYP4j" };
const T22 = "TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb"; const PROG = (tok) => (["ZCAT", "GOCAT", "PUMPCAT", "SEKR", "SOLCAT", "APECAT", "STONKCATS", "LEVERCAT", "BUYCAT", "RAYCAT", "SOMECAT"].includes(tok) ? T22 : T);
...
for (const c of cases) {
  ...
  try {
    ...
    const q = checkQuote(raw, { inputMint, outputMint, amountRaw, slippageBps: 100, slippageCapBps: 100, maxPriceImpactPct: 100, solHop: true });
    ...
    const checked = checkSwapTransaction({ txBase64, wallet, inputMint, outputMint, inputProgram: side === "buy" ? T : PROG(tok), outputProgram: side === "buy" ? PROG(tok) : T, amountRaw, quote: raw, slippageCapBps: 100, lookupTables: tables, maxPriorityFeeLamports: 50_000, allowedPairs: pairs, solHop: true });
    ...
    const tokenAta = associatedTokenAddress(wallet, t, PROG(tok)), settlementAta = associatedTokenAddress(wallet, s, T);
