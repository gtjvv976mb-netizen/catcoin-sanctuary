...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > A grey-and-white cat with grey-green eyes and a crooked, pleased grin. Fan tribute to Microsoft's cat. Not affiliated with or endorsed by Microsoft. A cat coin priced in MSFTx. Not affiliated with Microsoft Corporation or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields(name, symbol, story, look) `{"ok":true,"violations":[]}`. checkFields on the full description flags only the tribute line and the required disclosure (brand "microsoft", endorsement "endorsed", financial_promise "financial advice"). Jupiter: no token with that symbol (0 search results, 0 with that symbol). StonkFun: symbol and name not used yet (control search for AGI found it). Lengths: name 13/32, ticker 9/10, description 273/280. Re-checked 2026-09-25 23:27 UTC for the fan-tribute version.
...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > Harrumph, a fluffy flat-faced grey cat with a grumpy pout, glares at pigeons all morning. Fan tribute to Coinbase's cat. Not affiliated with or endorsed by Coinbase. A cat coin priced in COINx. Not affiliated with Coinbase or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields(name, symbol, story, look) `{"ok":true,"violations":[]}`. checkFields on the full description flags only the tribute line and the required disclosure (brand "coinbase", endorsement "endorsed", financial_promise "financial advice"). Jupiter: no token with that symbol (10 search results, 0 with that symbol). StonkFun: symbol and name not used yet (control search for AGI found it). Lengths: name 22/32, ticker 8/10, description 277/280. Re-checked 2026-09-25 23:27 UTC for the fan-tribute version.
...
- **Description** (for the cat's page and posts; StonkFun has no box for it):
  > A white calico who guards the garden pond like a moat. Fan tribute to Berkshire Hathaway's cat. Not affiliated with or endorsed by Berkshire Hathaway. A cat coin priced in BRK.Bx. Not affiliated with Berkshire Hathaway or StonkFun. No intrinsic value; not financial advice.
...
- **Checks:** checkProposal `{"ok":true,"violations":[]}`. checkFields(name, symbol, story, look) `{"ok":true,"violations":[]}`. checkFields on the full description flags only the tribute line and the required disclosure (brand "stonkfun", endorsement "endorsed", financial_promise "financial advice"). Jupiter: no token with that symbol (20 search results, 0 with that symbol). StonkFun: symbol and name not used yet (control search for AGI found it). Lengths: name 8/32, ticker 7/10, description 273/280. Re-checked 2026-09-25 23:27 UTC for the fan-tribute version.
