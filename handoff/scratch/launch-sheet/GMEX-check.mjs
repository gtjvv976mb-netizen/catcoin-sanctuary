...
const coins = [
  { name: "Save Point the Tabby", ticker: "SAVEPOINT", blurb: "Save Point, a small brown striped tabby with a cream chest and muzzle, finds the warmest stone in the garden, curls up on it and naps right there until the sun moves on." },
  { name: "Player Two the Kitten", ticker: "PLAYERTWO", blurb: "Player Two, a brown striped tabby kitten with a cream-white bib, trots after anyone crossing the garden and taps their ankle with one soft paw, sure it is her turn now." },
  { name: "Little Yowl the Tabby", ticker: "LILYOWL", blurb: "Little Yowl, a tiny brown striped tabby with a pale cream chest, has the biggest voice in the garden and uses it at dawn, at supper and whenever a leaf dares to move." },
];
