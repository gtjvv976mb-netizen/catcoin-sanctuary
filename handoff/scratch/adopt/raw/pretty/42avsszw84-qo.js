(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    t.s([
      ...
      "isLaunchableQuoteCategory",
      0,
      function (t) {
        return s(t) && !o.includes(t);
      },
      "isQuoteCategory",
      0,
      s,
  ...
  (t) => {
    ...
    let o = Array(12).fill(0),
      ...
      u = (t) => {
        var e;
        return "number" == typeof (null == t ? void 0 : t.id) ||
          (null == t || null == (e = t.id) ? void 0 : e.length) > 0
          ? t.id
          : c++;
      },
      f = new (class {
        constructor() {
          ((this.subscribe = (t) => (
            ...
            this.getActiveToasts().forEach((e) => t(e)),
            () => {
            ...
            (this.trimHistory = () => {
              let t = this.toasts.length - 100;
              t <= 0 ||
                (this.toasts = this.toasts.filter(
                  (e) =>
                    !(t > 0 && this.dismissedToasts.has(e.id)) ||
                    (this.dismissedToasts.delete(e.id), t--, !1),
                ));
            }),
            (this.create = (t) => {
              let { message: e, ...a } = t,
                o = u(t),
                r = this.pendingDismissals.get(o);
              void 0 !== r &&
                (cancelAnimationFrame(r),
                this.pendingDismissals.delete(o),
                this.dismissedToasts.delete(o));
              let s = this.dismissedToasts.has(o),
                n = void 0 === t.dismissible || t.dismissible;
              return (
                s &&
                  (this.dismissedToasts.delete(o),
                  (this.toasts = this.toasts.filter((t) => t.id !== o))),
                (s ? void 0 : this.toasts.find((t) => t.id === o))
                  ? (this.toasts = this.toasts.map((a) =>
                      a.id === o
                        ? (this.publish({ ...a, ...t, id: o, title: e }),
                          { ...a, ...t, id: o, dismissible: n, title: e })
                        : a,
                    ))
                  : this.addToast({ title: e, ...a, dismissible: n, id: o }),
                o
              );
            }),
            (this.dismiss = (t) => {
              if (null == t)
                return (
                  this.getActiveToasts().forEach((t) => {
              ...
              let e = this.pendingDismissals.get(t);
              return (
            ...
            (this.message = (t, e) =>
              this.create({ ...e, message: t, type: void 0 })),
            (this.error = (t, e) =>
                      ...
                      let o =
                        ...
                        s =
                          "function" == typeof a.description
                            ...
                            : a.description,
                        i =
                          "object" != typeof o || e.default.isValidElement(o)
                            ? { message: o }
                            : o;
                      this.create({
                        id: r,
            ...
            (this.custom = (t, e) => {
              let a = u(e);
              return (this.create({ ...e, jsx: t(a), id: a, type: void 0 }), a);
            }),
    ...
    let b = (t) => {
      ...
      let {
        ...
        [Q, X] = e.default.useState(null),
        [G, K] = e.default.useState(null),
        [q, W] = e.default.useState(!1),
        [J, Z] = e.default.useState(!1),
        [tt, te] = e.default.useState(!1),
        [ta, to] = e.default.useState(!1),
        [tr, ts] = e.default.useState(!1),
        [tn, ti] = e.default.useState(0),
        [tl, td] = e.default.useState(0),
        tc = e.default.useRef(E.duration || $ || 4e3),
        tu = e.default.useRef(null),
        tf = e.default.useRef(null),
        tm = 0 === M,
        tp = M + 1 <= C,
        th = E.type,
        tg = null != th ? th : "default",
        tb = !1 !== E.dismissible,
        tv = E.className || "",
        ty = E.descriptionClassName || "",
        tx = e.default.useMemo(
          () => N.findIndex((t) => t.toastId === E.id) || 0,
          [N, E.id],
        ),
        tw = e.default.useMemo(() => {
          var t;
          return null != (t = E.closeButton) ? t : z;
        }, [E.closeButton, z]),
        tE = e.default.useMemo(() => E.duration || $ || 4e3, [E.duration, $]),
        tk = e.default.useRef(0),
        tT = e.default.useRef(0),
        tS = e.default.useRef(0),
        tC = e.default.useRef(null),
        [tN, tM] = O.split("-"),
        tB = e.default.useMemo(
          () => N.reduce((t, e, a) => (a >= tx ? t : t + e.height), 0),
          [N, tx],
        ),
        tA = (() => {
        ...
        tR = e.default.useMemo(() => {
          var e;
          return null != (e = t.swipeDirections)
            ? e
            : (function (t) {
                let [e, a] = t.split("-"),
                  o = [];
        ...
        tD = E.invert || w,
        tz = "loading" === th;
      ((tT.current = e.default.useMemo(() => tx * U + tB, [tx, tB])),
        e.default.useEffect(() => {
          tc.current = tE;
        }, [tE]),
        e.default.useEffect(() => {
        ...
        }, [q, E.title, E.description, S, E.id, E.jsx, E.action, E.cancel]));
      let tj = e.default.useCallback(() => {
        (Z(!0),
          ti(tT.current),
          S((t) => t.filter((t) => t.toastId !== E.id)),
          setTimeout(() => {
      ...
      function tL() {
        var t, a;
        return (null == _ ? void 0 : _.loading)
          ? e.default.createElement(
              "div",
              {
                className: g(
                  null == V ? void 0 : V.loader,
                  null == E || null == (a = E.classNames) ? void 0 : a.loader,
                  "sonner-loader",
                ),
      ...
      (e.default.useEffect(() => {
        ...
        if (
          ...
          if (A || T || tA) {
            if (tS.current < tk.current) {
              let t = new Date().getTime() - tk.current;
      ...
      return e.default.createElement(
        "li",
        {
          ...
          className: g(
            ...
            null == V ? void 0 : V[tg],
            null == E || null == (o = E.classNames) ? void 0 : o[tg],
          ),
          "data-sonner-toast": "",
          "data-rich-colors": null != (y = E.richColors) ? y : D,
          ...
          style: {
            ...
            "--toasts-before": M,
            "--z-index": B.length - M,
            "--offset": `${J ? tn : tT.current}px`,
            "--initial-height": H ? "auto" : `${tl}px`,
            ...j,
            ...E.style,
          },
          onDragEnd: () => {
            (te(!1), X(null), (tC.current = null));
          },
          onPointerDown: (t) => {
            2 === t.button ||
              tz ||
              ...
              "BUTTON" !== t.target.tagName &&
                (te(!0), (tC.current = { x: t.clientX, y: t.clientY })));
          },
          onPointerUp: () => {
            var t, e, a, o, r;
            if (ta || !tb) return;
            ...
            if (
              ("x" === Q
                ? tR.includes(s > 0 ? "right" : "left")
                : tR.includes(n > 0 ? "bottom" : "top")) &&
              (Math.abs(l) >= 45 || d > 0.11)
            ) {
              (ti(tT.current),
          ...
          onPointerMove: (t) => {
            ...
            if (
              ...
              return;
            let r = t.clientY - tC.current.y,
              s = t.clientX - tC.current.x;
            !Q &&
              (Math.abs(s) > 1 || Math.abs(r) > 1) &&
              X(Math.abs(s) > Math.abs(r) ? "x" : "y");
            let n = { x: 0, y: 0 },
              i = (t) => 1 / (1.5 + Math.abs(t) / 20);
            if ("y" === Q) {
              if (tR.includes("top") || tR.includes("bottom"))
                if (
                  (tR.includes("top") && r < 0) ||
                  (tR.includes("bottom") && r > 0)
                )
                  n.y = r;
                else {
                  let t = r * i(r);
                  n.y = Math.abs(t) < Math.abs(r) ? t : r;
                }
            } else if (
              "x" === Q &&
              (tR.includes("left") || tR.includes("right"))
            )
              if (
                (tR.includes("left") && s < 0) ||
                (tR.includes("right") && s > 0)
              )
                n.x = s;
              else {
                let t = s * i(s);
                n.x = Math.abs(t) < Math.abs(s) ? t : s;
              }
            ((Math.abs(n.x) > 0 || Math.abs(n.y) > 0) && ts(!0),
              null == (a = tf.current) ||
                a.style.setProperty("--swipe-amount-x", `${n.x}px`),
              null == (o = tf.current) ||
                o.style.setProperty("--swipe-amount-y", `${n.y}px`));
          },
        },
        tw && !E.jsx && "loading" !== th
          ? e.default.createElement(
              "button",
              {
                ...
                className: g(
                  ...
                  null == E || null == (c = E.classNames)
                    ? void 0
                    : c.closeButton,
                ),
              },
              null != (x = null == _ ? void 0 : _.close) ? x : d,
            )
          : null,
        (th || E.icon || E.promise) &&
          null !== E.icon &&
          ((null == _ ? void 0 : _[th]) !== null || E.icon)
          ? e.default.createElement(
              "div",
              {
                "data-icon": "",
                className: g(
                  ...
                  null == E || null == (u = E.classNames) ? void 0 : u.icon,
                ),
              },
              "loading" === th ? E.icon || tL() : E.promise ? tL() : null,
              "loading" !== th ? tY : null,
            )
          : null,
        e.default.createElement(
          ...
          e.default.createElement(
            "div",
            {
              ...
              className: g(
                ...
                null == E || null == (m = E.classNames) ? void 0 : m.title,
              ),
            },
      ...
      let {
        ...
        A = e.default.useMemo(
          () =>
            Array.from(
              new Set(
                [n].concat(B.filter((t) => t.position).map((t) => t.position)),
              ),
            ),
          [B, n],
        ),
        ...
        O = i.join("+").replace(/Key/g, "").replace(/Digit/g, ""),
            ...
            return B.length
              ? e.default.createElement(
                  "ol",
                  {
                    ...
                    "data-x-position": f,
                    style: {
                      "--front-toast-height": `${(null == (r = R[0]) ? void 0 : r.height) || 0}px`,
                      "--width": "356px",
                      "--gap": `${k}px`,
                      ...y,
                      ...((n = {}),
                    ...
                    onFocus: (t) => {
                      !(
                        ...
                        (H.current ||
                          ((H.current = !0), (U.current = t.relatedTarget)));
                    },
                    onMouseEnter: () => j(!0),
                    onMouseMove: () => j(!0),
                    onMouseLeave: () => {
                  ...
                  B.filter(
                    ...
                    return e.default.createElement(b, {
                      ...
                      defaultRichColors: h,
                      duration:
                        null != (n = null == w ? void 0 : w.duration) ? n : g,
                      ...
                      closeButtonAriaLabel:
                        null == w ? void 0 : w.closeButtonAriaLabel,
                      removeToast: V,
                      toasts: B.filter((t) => t.position == o.position),
                      heights: R.filter((t) => t.position == o.position),
                      setHeights: D,
                      expandByDefault: l,
                      gap: k,
                      expanded: z,
